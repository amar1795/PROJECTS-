...
const page = ({ params }: { params: { product: string } }) => {
  ...
  const [data, setData] = React.useState<updatedDataResponse | null>(null);  //     const categoryRightProps={
  //         brand:data?.brand,
...
price:number, 
rating:ratingsProps, */}
              {/* <CategoriesRight brand={data?.brand?.name}/> */}
              ...
              <div>
                <div className=" bg-pink-500  ">
                  <div className=" px-4">
                    ...
                    <div className=" mt-2">
                      <div className=" flex justify-between w-[10rem]  mb-2">
                        ...
                        <div className=" flex px-5 self-center">
                          ...
                          <h1 className=" text-[2.5rem] font-bold">{data?.price}</h1>
                        </div>
                      </div>
                    ...
                    <div className=" border-b-2 border-gray-300 mt-5"></div>
                    <div className="  bg-red-600 mt-10 text-[1.2rem]">
