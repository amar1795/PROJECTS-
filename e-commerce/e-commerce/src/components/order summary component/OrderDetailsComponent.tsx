      ...
      <div className="  bg-yellow-500 mt-4">
                  <div className=" flex  text-[1.3rem] border-2 border-black border-b-8 border-r-4">
                    ...
                    <div className=" price py-4">
                      <h1 className=" py-2 px-2">{orderItem.product.name}</h1>
                      <h1 className=" py-2 px-2">{orderItem.product.brand.name}</h1>
                      <h1 className=" py-2 px-2">Qty <span>{orderItem.quantity}</span></h1>
                      <h1 className=" py-2 px-2">Price <span>{orderItem.price}</span></h1>
